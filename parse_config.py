...
__C.TRAIN.IMAGE_PATH = ''
__C.TRAIN.STYLE_PATH = ''
__C.TRAIN.LAPLACE_PATH = ''
__C.TRAIN.LABEL_PATH = ''
__C.TRAIN.SHORT_IMG_PATH = ''
__C.TRAIN.SHORT_LABEL_PATH = ''
...
__C.TEST.IMS_PER_BATCH = 16

__C.TEST.IMAGE_PATH = ''
__C.TEST.STYLE_PATH = ''
__C.TEST.LAPLACE_PATH = ''
__C.TEST.LABEL_PATH = ''
...
# Maximum number of trainning epochs
